...
const knaCatArray = () => {
  return [
    ...
    { code: '008', description: 'BIBLIOGRAFIA' },
    { code: '016', description: 'BIBLIOTECONOMIA E CIÊNCIA DA INFORMAÇÃO' },
    { code: '024', description: 'ENCICLOPÉDIAS GERAIS' },
    { code: '040', description: 'PUBLICAÇÕES SERIADAS' },
    { code: '048', description: 'ORGANIZAÇÕES DE CARÁTER GERAL E MUSEOLOGIA' },
    {
      code: '056',
